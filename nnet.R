...
tuning = expand.grid(seed=round(runif(100, min = 0, max = 1000 )))
...
############## tuning on number of layer


tuning = expand.grid(unit=round(runif(5, min = 0, max = 50 )))
tuning = cbind(tuning, performance = rep(0, nrow(tuning)))
